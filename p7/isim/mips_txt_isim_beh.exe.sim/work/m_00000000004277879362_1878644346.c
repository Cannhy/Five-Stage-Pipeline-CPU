...
#endif
static const char *ng0 = "E:/p7_v/p7_E_Reg.v";
static int ng1[] = {1, 0};
static int ng2[] = {0, 0};
...
LAB87:    memcpy(t6, t37, 8);

LAB88:    t60 = (t0 + 3368);
    xsi_vlogvar_wait_assign_value(t60, t6, 0, 0, 1, 0LL);
...
LAB74:    memcpy(t37, t30, 8);

LAB75:    goto LAB57;

LAB58:    xsi_vlog_unsigned_bit_combine(t6, 32, t7, 32, t37, 32);
    goto LAB62;

LAB60:    memcpy(t6, t7, 8);
    goto LAB62;
...
LAB71:    xsi_vlog_unsigned_bit_combine(t37, 32, t35, 32, t30, 32);
    goto LAB75;

LAB73:    memcpy(t37, t35, 8);
    goto LAB75;
...
LAB100:    memcpy(t37, t61, 8);

LAB101:    goto LAB83;

LAB84:    xsi_vlog_unsigned_bit_combine(t6, 32, t7, 32, t37, 32);
    goto LAB88;

LAB86:    memcpy(t6, t7, 8);
    goto LAB88;
...
LAB111:    if (*((unsigned int *)t89) > 0)
        goto LAB112;

LAB113:    memcpy(t61, t52, 8);

LAB114:    goto LAB96;

LAB97:    xsi_vlog_unsigned_bit_combine(t37, 32, t30, 32, t61, 32);
    goto LAB101;

LAB99:    memcpy(t37, t30, 8);
    goto LAB101;

LAB102:    *((unsigned int *)t89) = 1;
    goto LAB105;
...
LAB110:    xsi_vlog_unsigned_bit_combine(t61, 32, t104, 32, t52, 32);
    goto LAB114;

LAB112:    memcpy(t61, t104, 8);
    goto LAB114;

}


extern void work_m_00000000004277879362_1878644346_init()
{
	static char *pe[] = {(void *)Always_46_0};
	xsi_register_didat("work_m_00000000004277879362_1878644346", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000004277879362_1878644346.didat");
